...
{
  CGUIDialogSmartPlaylistRule *editor = dynamic_cast<CGUIDialogSmartPlaylistRule*>(CServiceBroker::GetGUI()->GetWindowManager().GetWindow(WINDOW_DIALOG_SMART_PLAYLIST_RULE));
