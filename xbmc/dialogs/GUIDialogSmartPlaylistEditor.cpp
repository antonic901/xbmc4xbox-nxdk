...
{
  CGUIDialogSmartPlaylistEditor *editor = dynamic_cast<CGUIDialogSmartPlaylistEditor*>(CServiceBroker::GetGUI()->GetWindowManager().GetWindow(WINDOW_DIALOG_SMART_PLAYLIST_EDITOR));
