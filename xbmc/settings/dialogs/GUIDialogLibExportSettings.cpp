...
{
  CGUIDialogLibExportSettings *dialog = dynamic_cast<CGUIDialogLibExportSettings*>(CServiceBroker::GetGUI()->GetWindowManager().GetWindow(WINDOW_DIALOG_LIBEXPORT_SETTINGS));
  if (!dialog)
    return false;
